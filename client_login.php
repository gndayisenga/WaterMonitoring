...
if (isset($_POST['login'])){
    $meter = $_POST['meter_id'];
    $telephone = $_POST['telephone'];

    $sql = "SELECT * FROM `device` WHERE `device_number` = '{$meter}' ";
    $query = $connPDO -> query($sql);
    if ($query->rowCount() > 0){
        $row = $query->fetch(PDO::FETCH_ASSOC);
        session_start();
        $_SESSION['meter'] = $row['device_number'];
        $_SESSION['name'] = $row['owner_name'];  //quantity
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="text-center mt-0 m-b-15">
                                    <a href="./" class="logo logo-admin"><img src="../assets/images/logo-dark.png" height="60" alt="logo"></a>
                                </h3>

                                <h4 class="text-muted text-center font-18"><b>Search meter information</b></h4>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal m-t-20" action="" method="post">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <input class="form-control" name="meter_id" type="text" required="" placeholder="meter number">
                                            </div>
                                        </div>
